<?php
/**
 * Main Plugin class for QuickLook for WooCommerce
 *
...
class Plugin {
	...
	public function init() {
		...
		add_filter( 'plugin_action_links_' . QUICKLOOK_WC_PLUGIN_BASENAME, array( $this, 'add_settings_link' ) );
	}
	...
	public function add_settings_link( $links ) {
		$settings_link = '<a href="' . admin_url( 'admin.php?page=wc-settings&tab=products&section=quicklook_wc' ) . '">' . __( 'Settings', 'quicklook-for-woocommerce' ) . '</a>';
